...
INSERT INTO `clientes` (`id_cliente`, `nit`, `nombres`, `apellidos`, `direccion`, `telefono`, `fecha_nacimiento`) VALUES
	(1, '12345679', 'Dennys', 'Stuar', 'Boca', '12345678', '2002-07-16'),
	(2, '11111111', 'Prueba', 'Prueba', 'Prueba', '12345678', '1995-09-17'),
	(3, '32165478', 'Juan Perez', 'Perez', 'Villa Nueva', '342456376', '2025-01-11');
...
INSERT INTO `empleados` (`id_empleado`, `codigo`, `nombres`, `apellidos`, `direccion`, `telefono`, `fecha_nacimiento`, `id_puesto`) VALUES
	(1, 'E001', 'Dennys', 'Hernandez', 'Boca', '12345678', '2001-02-26', 1),
	(2, 'E002', 'Henry', 'Estuardo', 'Villa Canales, Guatemala', '345667842', '2024-06-20', 1),
	(3, 'E003', 'Alexandra', 'Flores', 'Zona 7', '7853421234', '2000-05-05', 2),
	(6, 'E004', 'Jose', 'Cruz', 'Ciudad', '1234569', '2024-02-15', 2);
